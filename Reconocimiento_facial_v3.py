# La version 3 es una red densa de 70000 datos, y 40 etiquetas
import numpy as np
import pandas as pd
import patlib
...
attributes_index = df.iloc[0:N_d,1:N_e+1].to_numpy()
for i in range(N_d):
    for j in range(N_e):
...
#-------------------------------------------------------------------------------
#                               WandB callbaks
wandb.init(project="Reconocimiento_Facial_v3.6")
...
model.save('redes_entrenadas/reconocimiento_facial_v3.6.h5')
